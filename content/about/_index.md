...
## The Stack
- **Compute:** Proxmox VE (6 nodes)
- **Kubernetes:** K3s on 12x Raspberry Pi
- **Observability:** Prometheus · Grafana · Node Exporter · Blackbox Exporter · Uptime Kuma
- **Network:** UniFi · VLAN segmentation · Cloudflare Tunnels
- **Storage:** TrueNAS
